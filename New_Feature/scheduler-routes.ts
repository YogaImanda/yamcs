...
// 👉 IMPORT KOMPUTEN BARU
import { ScheduledScriptsComponent } from './scheduled-scripts/scheduled-scripts.component';
...
export const ROUTES: Routes = [
  {
    ...
    children: [
      ...
      // ====== PROCEDURES: SCHEDULED SCRIPTS (BARU) ======
      {
        path: 'script/scheduled',
        pathMatch: 'full',
        component: ScheduledScriptsComponent,
      },
